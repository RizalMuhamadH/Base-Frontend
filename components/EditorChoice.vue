<template>
  <div class="col-span-1">
    <div
      class="font-bold text-yellow-500 text-2xl border-yellow-500 border-b-2 text-center py-2"
    >
      Editor Choice
    </div>
    <div class="divide-y divide-yellow-500 mt-3">
      <div class="flex flex-col py-3">
        ...
        <div class="text-black text-xs py-2">
          <span class="text-green-700 font-bold">Regional</span> | 31 September
          2021
        </div>
